...
MySQL - 5.6.12-log : Database - brainbox
*********************************************************************
*/
...
insert  into `admintopic`(`id`,`topicname`,`discription`) values (3,'.@science','gregregregerg'),(4,'.@hingu','vdsvdsvggdvdfbdbbdfdf'),(5,'.@general','all types of question'),(8,'.@mohit','ccewsc1234565'),(9,'.@ashu','boring man');
...
insert  into `answertable`(`Aid`,`answer`,`no_of_like`,`id`,`uid`) values (1,'dont want to say\r\n',0,2,8),(3,'i am hingu vikas',0,4,7),(5,'i am mohit',0,2,7);
...
insert  into `like_track_ans`(`ans_like_id`,`user_id`,`ans_id`) values (1,9,1),(2,4,1),(3,9,2),(4,7,1),(5,7,2);
...
insert  into `like_track_question`(`que_like_id`,`user_id`,`que_id`) values (1,4,2),(2,2,2),(3,7,2),(4,8,2),(5,9,2),(6,7,4),(7,7,4);
...
insert  into `postquestion`(`id`,`question_title`,`selected_topic`,`question_discription`,`uid`) values (2,'what is margin?',5,'dcdcdc',5),(3,'How do you post a question on Quora?',5,'To add a question, click “Ask Question” at the top right of the page. You will be shown questions that are similar to your question. If you don’t see your question, click “Ask Question” to add it to Q',7),(4,'who are you?',4,'vikas hingu',7);
...
insert  into `tbl_role`(`Rolepk`,`Rolename`,`Isactive`) values (1,'admin',1),(2,'user',1),(3,'expert',1);
...
insert  into `user_signup_table`(`username`,`password`,`conformpassword`,`email`,`rolefk`,`uid`) values ('hardik','123','123','bhbhjhbhbh@gmail.com',2,1),('mohit','123456',NULL,NULL,2,2),('parth','1234567',NULL,NULL,2,3),('hemal','12345678','12345678','bhbhjhbhbh@gmail.com',2,4),('admin','admin','admin',NULL,1,5),('Harsh Bhatt','1234','1234','hbhatt543@gmail.com',2,6),('kaps','kaps','kaps','hbhatt543@gmail.com',2,7),('kapsi','kapsi','kapsi','hbh543@gmail.com',2,8),('ashu','ashu','ashu','hbhatt543@gmail.com',2,9);
