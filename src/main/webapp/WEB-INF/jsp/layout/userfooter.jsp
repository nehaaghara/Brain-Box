					...
					<div class="col-md-8 col-md-offset-2">
						<div class="footer-content text-center no-padding margin-bottom-40">
							<div class="logo-footer">
								<img id="logo-footer" class="center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/logo-1.png" alt="">
							</div>
							...
							<div class="col-lg-7 col-sm-6 col-xs-12 column">
								<div class="footer-widget news-widget">
									...
									<div class="news-post">
										...
										<div class="news-content">
											<figure class="image-thumb">
												<img src="${pageContext.servletContext.contextPath}/webResource/user/images/popular-2.jpg" alt="">
									...
									<div class="news-post">
										...
										<div class="news-content">
											<figure class="image-thumb">
												<img src="${pageContext.servletContext.contextPath}/webResource/user/images/popular-1.jpg" alt="">
											</figure> <a href="#">If you need a crown or lorem an implant you will pay it gap it</a>
										</div>
										<div class="time">July 2, 2014</div>
									</div>
