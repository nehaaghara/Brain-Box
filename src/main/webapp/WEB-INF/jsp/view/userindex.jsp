										...
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="James John" href="#">
													<img alt="" class=" correct img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/2.jpg">
										...
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="Jessica" href="#">
													<img alt="" class="correct img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/3.jpg">
												</a> <span class="tick2"> <i class="fa fa-check" aria-hidden="true"></i> </span> 
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
										...
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="Muhammad Umair" href="#">
													<img alt="" class=" img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/4.jpg">
												</a>
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
								...
								<div id="tab2" class="tab-pane">
									...
									<div class="listing-grid">
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="Martina Jaz" href="#">
													<img alt="" class="correct img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/5.jpg">
												</a> <span class="tick2"> <i class="fa fa-check" aria-hidden="true"></i> </span> 
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
												<h3><a  href="#"> Php recursive function not working right</a></h3>
									...
									<div class="listing-grid ">
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="James John" href="#">
													<img alt="" class=" img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/6.jpg">
												</a>
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
												<h3><a  href="#"> How to retrieve RSS from multiple website</a></h3>
									...
									<div class="listing-grid ">
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="Jessica" href="#">
													<img alt="" class=" img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/7.jpg">
												</a>
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
												<h3><a  href="#"> Change navbar color in Twitter Bootstrap 3</a></h3>
									...
									<div class="listing-grid ">
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="Muhammad Umair" href="#">
													<img alt="" class="correct img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/8.jpg">
												</a> <span class="tick2"> <i class="fa fa-check" aria-hidden="true"></i> </span> 
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
												<h3><a  href="#"> Choosing bootstrap vs material design</a></h3>
								...
								<div id="tab3" class="tab-pane">
									...
									<div class="listing-grid">
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="Martina Jaz" href="#">
													<img alt="" class="correct img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/9.jpg">
												</a> <span class="tick2"> <i class="fa fa-check" aria-hidden="true"></i> </span> 
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
												<h3><a  href="#"> Php recursive function not working right</a></h3>
									...
									<div class="listing-grid ">
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="James John" href="#">
													<img alt="" class="correct img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/10.jpg">
												</a> <span class="tick2"> <i class="fa fa-check" aria-hidden="true"></i> </span> 
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
												<h3><a  href="#"> How to retrieve RSS from multiple website</a></h3>
									...
									<div class="listing-grid ">
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="Jessica" href="#">
													<img alt="" class="correct img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/11.jpg">
												</a> <span class="tick2"> <i class="fa fa-check" aria-hidden="true"></i> </span> 
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
												<h3><a  href="#"> Change navbar color in Twitter Bootstrap 3</a></h3>
									...
									<div class="listing-grid ">
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="Muhammad Umair" href="#">
													<img alt="" class="correct img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/12.jpg">
												</a> <span class="tick2"> <i class="fa fa-check" aria-hidden="true"></i> </span> 
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
												<h3><a  href="#"> Choosing bootstrap vs material design</a></h3>
								...
								<div id="tab4" class="tab-pane">
									...
									<div class="listing-grid">
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="Martina Jaz" href="#">
													<img alt="" class=" img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/5.jpg">
												</a>
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
												<h3><a  href="#"> Php recursive function not working right</a></h3>
									...
									<div class="listing-grid ">
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="James John" href="#">
													<img alt="" class=" img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/3.jpg">
												</a>
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
												<h3><a  href="#"> How to retrieve RSS from multiple website</a></h3>
									...
									<div class="listing-grid ">
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
												<a data-toggle="tooltip" data-placement="bottom" data-original-title="Muhammad Umair" href="#">
													<img alt="" class=" img-responsive center-block" src="${pageContext.servletContext.contextPath}/webResource/user/images/authors/12.jpg">
												</a>
											</div>
											<div class="col-md-7 col-sm-8  col-xs-12">
												<h3><a  href="#"> Choosing bootstrap vs material design</a></h3>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						<div class="blog-grid">
							<div class="blog-image">
								<img alt="blog-image1" class="img-responsive" src="${pageContext.servletContext.contextPath}/webResource/user/images/blog/1.jpg">
							</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						<div class="blog-grid">
							<div class="blog-image">
								<img alt="blog-image1" class="img-responsive" src="${pageContext.servletContext.contextPath}/webResource/user/images/blog/2.jpg">
							</div>
							<div class="blog-content">
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						<div class="blog-grid">
							<div class="blog-image">
								<img alt="blog-image1" class="img-responsive" src="${pageContext.servletContext.contextPath}/webResource/user/images/blog/3.jpg">
							</div>
							<div class="blog-content">
							...
							<div class="item"> <i class="fa fa-quote-left"> </i>
								...
								<div class="client-info-wrap clearfix">
									<div class="client-img">
										<img class="img-circle" src="${pageContext.servletContext.contextPath}/webResource/user/images/client-img-two.jpg" alt="" />
									</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-2 col-sm-4 col-xs-6 client-block">
						...
						<div class="client-item client-item-style-2">
							<a title="Client Logo" href="#">
								<img alt="Clients Logo" src="${pageContext.servletContext.contextPath}/webResource/user/images/clients/client_5.png">
							</a>
						</div>
						<!-- /client-item client-item-style-2 -->
					</div>
					...
					<div class="col-md-2 col-xs-6 col-sm-4 client-block">
						...
						<div class="client-item client-item-style-2">
							<a title="Client Logo" href="#">
								<img alt="Clients Logo" src="${pageContext.servletContext.contextPath}/webResource/user/images/clients/client_6.png">
							</a>
						</div>
						<!-- /client-item client-item-style-2 -->
					</div>
					...
					<div class="col-md-2  col-xs-6 col-sm-4 client-block">
						...
						<div class="client-item client-item-style-2">
							<a title="Client Logo" href="#">
								<img alt="Clients Logo" src="${pageContext.servletContext.contextPath}/webResource/user/images/clients/client_7.png">
							</a>
						</div>
						<!-- /client-item client-item-style-2 -->
					</div>
					...
					<div class="col-md-2 col-xs-6 col-sm-4 client-block">
						...
						<div class="client-item client-item-style-2">
							<a title="Client Logo" href="#">
								<img alt="Clients Logo" src="${pageContext.servletContext.contextPath}/webResource/user/images/clients/client_8.png">
							</a>
						</div>
						<!-- /client-item client-item-style-2 -->
					</div>
					...
					<div class="col-md-2 col-xs-6 col-sm-4 client-block">
						...
						<div class="client-item client-item-style-2">
							<a title="Client Logo" href="#">
								<img alt="Clients Logo" src="${pageContext.servletContext.contextPath}/webResource/user/images/clients/client_9.png">
							</a>
						</div>
						<!-- /client-item client-item-style-2 -->
					</div>
					...
					<div class="col-md-2 col-xs-6 col-sm-4 client-block">
						...
						<div class="client-item client-item-style-2">
							<a title="Client Logo" href="#">
								<img alt="Clients Logo" src="${pageContext.servletContext.contextPath}/webResource/user/images/clients/client_10.png">
							</a>
						</div>
						<!-- /client-item client-item-style-2 -->
					</div>
				...
				<div class="row">
					<div class="app-content">
						...
						<div class="col-md-4 col-sm-4">
							<a href="#" class="app-grid"> <span class="app-icon"> <img alt="#" src="${pageContext.servletContext.contextPath}/webResource/user/images/mobile.png"> </span>
								<div class="app-title">
						...
						<!-- Single download start \-->
						<div class="col-md-4 col-sm-4">
							<a href="#" class="app-grid"> <span class="app-icon"> <img alt="#" src="${pageContext.servletContext.contextPath}/webResource/user/images/play-store.png"> </span>
								<div class="app-title">
									<h5>Available on the</h5>
									<h3>Google Store</h3>
								</div>
						...
						<!-- Single download start \-->
						<div class="col-md-4  col-sm-4">
							<a href="#" class="app-grid"> <span class="app-icon"> <img alt="#" src="${pageContext.servletContext.contextPath}/webResource/user/images/windows.png"> </span>
								<div class="app-title">
									<h5>Available on the</h5>
									<h3>Windows Store</h3>
								</div>
				...
				<div class="col-md-12">
					<div class="social-bar">
						<ul>
							<li class="social1">
								<a title="" href="#">
									<img alt="" src="${pageContext.servletContext.contextPath}/webResource/user/images/facebook.png"> <span>Join Us On<strong>FACEBOOK</strong></span> 
								</a>
							</li>
							<li class="social2">
								<a title="" href="#">
									<img alt="" src="${pageContext.servletContext.contextPath}/webResource/user/images/twitter.png"> <span>Join Us On<strong>TWIITER</strong></span> 
								</a>
							</li>
							<li class="social3">
								<a title="" href="#">
									<img alt="" src="${pageContext.servletContext.contextPath}/webResource/user/images/google-plus.png"> <span>Join Us On<strong>GOOGLE PLUS</strong></span> 
								</a>
							</li>
							<li class="social4">
								<a title="" href="#">
									<img alt="" src="${pageContext.servletContext.contextPath}/webResource/user/images/linkedin.png"> <span>Join Us On<strong>LINKED IN</strong></span> 
								</a>
							</li>
						</ul>
					</div>
